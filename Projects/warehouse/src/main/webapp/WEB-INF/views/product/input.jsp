...
<body>
    <form:form action="/product/saveOrUpdate" modelAttribute="product" method="POST" id="myForm">
       <form:hidden path="id"/>
        <div id="inputForm">
            <div id="navigation">
                <span id="nav_title">Product Information</span>
            </div>
            <div class="inputArea">
                <table class="table">
                    <tr>
                    ...
                    <tr>
                        <td class="text_left">Product CostPrice</td>
                        <td class="text_right">
                            <form:input path="costPrice" cssClass="input_ui"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="text_left">Brand Name</td>
                        <td class="text_right">
                            <form:select path="brandName.id" cssClass="select_ui">
                                <form:options items="${brandNameList}" itemLabel="name" itemValue="id"/>
                            </form:select>
                        </td>
                    </tr>
                    <tr>
