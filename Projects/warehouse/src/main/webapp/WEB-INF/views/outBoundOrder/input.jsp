...
<html>
<head>
    <title>Outbound Order InputPage</title>
    ...
    <script type="text/javascript" src="/asset/js/domain/outBoundOrderList.js"></script>
</head>
<body>
            ...
            <div class="inputArea">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td class="text_right">
                            <form:select path="constructionSite.id" cssClass="select_ui">
                                <form:options items="${siteList}" itemLabel="name" itemValue="id"/>
                            </form:select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text_right">
                            ...
                            <fmt:formatDate value="${outBoundOrder.outBoundDate}" var="outBoundDate" pattern="yyyy-MM-dd" />
                                        <%--<form:input type="date"> is used to create an input field for the "outBoundDate" property
                                             of outBoundOrder. It allows the user to select a date form a calendar or enter it manually.
                        ...
                        <td class="text_right">
                            <div class="tableResult">
                                ...
                                <table class="table">
                                    ...
                                    <c:choose>
                                        <%--When the outBoundOrder id is empty, it means the user add a outBoundOrder.
                                         Show the user with a page with empty input field.--%>
                                        <c:when test="${empty outBoundOrder.id}">
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <c:if test="${permissionFn:checkPermission('org.construction.wms.web.controller.OutBoundOrderItemController:delete')}">
                                        ...
                                        <c:otherwise>
                                            <%--If the id of outBoundOrder is not null, it means the user edit an outBoundOrder.--%>
                                            <c:choose>
                                                <%--(Please refer to line 129 in outBoundOrderController when itemsId == null in saveOrUpdate method.)
                                                when all the items has been deleted and there are no items in a existing outbound order list, the user click edit
                                                and it will return a page with outbound order serial number, construction site, outBoundDate and a empty outbound order item list.--%>
                                                ...
                                                <c:otherwise>
                                                    <%--For the case when there is any outBoundOrderItem in an outBoundOrder, it will show page with outBoundOrderItem.
                                                    For Case 2 and Case 3 in saveOrUpdate method in outBoundOrderController, it will show below page.--%>
